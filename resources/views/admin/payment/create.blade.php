                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6 col-lg-12">
                                    {!! Form::open(['route' => 'admin.payment.store', 'data-parsley-validate' => '', 'files' => true, 'method' => 'POST  ']) !!}
                                    <fieldset>
                                        <h5>Nama
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <input id="description"  name="description" type="text" class="form-control date-inputmask" placeholder="Deskripsi"
                                            />
                                        </div>
                                    </fieldset>
