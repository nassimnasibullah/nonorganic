                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6 col-lg-12">
                                    {!! Form::model($product, ['route' => ['admin.product.update', $product->id], 'method' => 'PUT', 'files' => true]) !!}                                    <fieldset>
                                    ...
                                    <div class="form-actions">
                                        <div class="text-right">
                                            ...
                                            <button type="submit" class="btn btn-warning">Reset <i class="ft-refresh-cw position-right"></i></button>
                                            {!! Form::close() !!}
